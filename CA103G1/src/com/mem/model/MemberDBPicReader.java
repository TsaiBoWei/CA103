...
public class MemberDBPicReader extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			ResultSet rs = stmt.executeQuery(
				"SELECT MEM_PHOTO from MEM where MEM_ID='"+memID+"'");
...
//				res.sendError(HttpServletResponse.SC_NOT_FOUND);
				InputStream in=getServletContext().getResourceAsStream("/img/NoData/null.jpg");

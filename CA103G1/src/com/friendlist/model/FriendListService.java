...
public class FriendListService {
	...
	public FriendListVO addFriendList(String fl_friend_name,String fl_status,String fl_block) {
	...
	public void deleteFriend(String fl_memA_id, String fl_memB_id) {
		dao.delete(fl_memA_id, fl_memB_id);
	}
	
	public FriendListVO getOneFriend(String fl_memA_id, String fl_memB_id) {

...
public class EventAdVO implements Serializable{
	...
	public EventAdVO(String ead_id, String mem_id, byte[] ead_pic, String ead_ptype, String ead_status) {
		super();
		this.ead_id = ead_id;
		this.mem_id = mem_id;
		this.ead_pic = ead_pic;
		this.ead_ptype = ead_ptype;
	...
	public String getEad_ptype() {
		return ead_ptype;
	}


	public void setEad_ptype(String ead_ptype) {
		this.ead_ptype = ead_ptype;
	}

 ...
 */
@WebServlet("/DBChatEveReader")
public class DBChatEveReader extends HttpServlet {
...
//			System.out.println(e);
			InputStream in=getServletContext().getResourceAsStream("/front_end/event/evechat/img/basketball.png");
			byte[] b=new byte[in.available()];
			in.read(b);
			out.write(b);
			in.close();

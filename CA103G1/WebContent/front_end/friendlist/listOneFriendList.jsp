...
<%
	FriendListVO firendlistVO = (FriendListVO) request.getAttribute("firendlistVO"); //FriendListServlet.java(Concroller), 存入req的empVO物件
%>

<html>
<head>
<title>會員的好友清單 - listOneFriendList.jsp</title>

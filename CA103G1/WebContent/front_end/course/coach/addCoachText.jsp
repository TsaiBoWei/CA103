    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <i class="fa fa-address-book text-md-left"></i> &nbsp; 新增教練資訊 &nbsp; <br>
          </h2>
...
<!--           <p class="text-md-left">" * " 為必填項目</p> -->
          ...
          <form METHOD="post" ACTION="<%=request.getContextPath()%>/coach/coach.do" name="form1" enctype="multipart/form-data">
            ...
            <div class="form-group">
				...
				<textarea name="coa_text" cols="50" rows="5" class="form-control"
				value="<%= (coachVO==null)? "請輸入教練資訊" : coachVO.getCoa_text()%>" ></textarea>
			</div>
			<br>

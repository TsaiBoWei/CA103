...
<!-- CSS dependencies -->
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/front_end/css/neon.css">
<link rel="stylesheet"
...
<script src="<%=request.getContextPath()%>/front_end/js/navbar-ontop.js"></script>
<!-- Script: Animated entrance -->
<script src="<%=request.getContextPath()%>/front_end/js/animate-in.js"></script>
<!-- summernote -->
...
<!-- 								<!--- if erroMsg --->
			...
			<script>
			 ...
			 $(document).ready(function() {
			        $(".cancel").click(function() {
			             ...
			             $(location).attr('href', '<%=request.getContextPath()%>/front_end/course/courboar/page/maincourboar.jsp');
			...
			<div class="col-12 col-sm-12 mt-5 ">
				<div class="col-12 col-sm-10 offset-md-1">
					<div class="accordion" id="accordionExample">
						...
						<%	for(int i=0; i<courboarlist.size(); i++) {
			                 ...
			                 CourBoarVO courboarVO = courboarlist.get(i); 
			            %>
                       <!--CRPOSTformem-->
                        <%
						...
						<div class="card">
						  ...
						  <script>
						   ...
						   <%System.out.println(mem_id.equals(courboarVO.getMem_id())); %>
				          </c:if>	
	...
	<!--courboar-->
		...
		<script
			src="<%=request.getContextPath()%>/front_end/js/smooth-scroll.js"></script>

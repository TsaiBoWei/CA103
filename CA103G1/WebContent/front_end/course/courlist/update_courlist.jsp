    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <i class="fa fa-book text-md-left"></i> &nbsp; 修改課程 &nbsp; <br>
          </h2>
		...
		<div class="text-md-left">
          ...
          <form METHOD="post" ACTION="<%=request.getContextPath()%>/courlist/courlist.do" name="form1" enctype="multipart/form-data">
            ...
            <div class="form-group">
				<h4 class="text-md-left">課程編號：<%=courlistVO.getCour_id()%></h4>
			</div>
			<br>
...
<!-- 			教練編號  -->
            <div class="form-group">
				<input type="hidden" name="coa_id" value="<%=courlistVO.getCoa_id()%>" />
			</div>
			<br>
			...
			<div class="form-group text-md-left">
              <h4 class="text-md-left">課程主頁圖*</h4>
              	<img class="img-fluid d-block mx-auto" alt="Card image"

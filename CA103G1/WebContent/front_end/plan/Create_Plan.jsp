...
// 		$("#plan_votext").text("2018-10-26 11:00 ");
		$("#plan_votext").text("健身房上部大肌群訓練計畫菜單:<br>●全身大肌群訓練計畫<br>運動頻率：3次/每5天。運動時間：60分鐘（不包括暖身及伸展）。<br>運動內容：深蹲、伏地挺身、握推（8~12RM，組間休息2~3分鐘，每個動作4組）。伸展（每個動作15~30秒，重複2~4組）1.機器胸推。建議每組8~12下，2~4組，組間休息1分鐘。2.機器夾胸。建議每組8~12下，2~4組，組間休息1分鐘。3.寬握坐姿划船　建議每組8~12下，2~4組，組間休息1分鐘。");

...
<body class="text-center">
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link personalnavlink"
						...
						rel="<%=request.getContextPath()%>/index.jsp"> <i
							class="fa fa-file"></i>&nbsp;&nbsp; HomePage &nbsp; &nbsp;&nbsp;
					</a></li>

					<!-- Workoutplan-->
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle personalnavlink"
						aria-haspopup="true" id="workoutplan" aria-expanded="false"
					...
					<!-- Friend-->
					<li class="nav-item"><a class="nav-link personalnavlink"
						style="cursor: pointer;" id="friend"
	...
	<a class="btn btn-lg btn-primary" href="#posteditlight"
		data-rel="lightcase:myCollection:slideshow" id="bli_kontaktad_landing">
				...
				<div class="col-12  mx-auto">
					<form method="post" class="select"
						...
						<div class="form-row">
							...
							<div class="form-group col-md-2">
								<select class="form-control" name="plan_privacy"
									id="inputPassword4" style="font-size: 18px">
									<option>隱私權
						...
						<br> <input type="hidden" name="action"
							value="listPlans_ByCompositeQuery">
					</form>
				</div>
			</div>
		</div>
